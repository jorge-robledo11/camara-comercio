...
mindmap
  root((🔍 Descubrimiento))
    💡 Idea vs Venta vs Ganancia
    🏠 Costos Fijos
      Se pagan sí o sí
    📦 Costos Variables
      Suben si produces más
    🧮 Precio de venta
      Costo total + margen
```
...
mindmap
  root((✈️ Despegue))
    ⭐ Estrella
      Se vende mucho y deja buena plata
    🐄 Vaca
      Se vende mucho pero deja poco
    💎 Diamante
      Deja buena plata pero se vende poco
    🐕 Perro
      Ni se vende ni deja plata
    ⚖️ Equilibrio multiproducto
      Promediar los márgenes
```
...
mindmap
  root((🌱 Crecimiento))
    📋 Costos ordenados
      🏠 Fijos → Se pagan sí o sí
      📦 Variables → Suben al vender más
    🗺️ Modelo Canvas
      Cómo creo, entrego y capturo valor
    💸 Flujos de ingreso
      Venta unitaria
      Combos
      Corporativos
      Suscripción
    📝 Ajustar precios
      Que el margen se mantenga sano
```
...
mindmap
  root((🏆 Madurez))
    📊 ¿Qué línea deja más plata?
    🔍 ¿Qué costos puedo bajar?
    🏷️ ¿Qué precios debo subir?
...
mindmap
  root((🐷 Ahorro))
    ...
    🚀 Motor
      Para crecer
    🪙 Sobreprecio invisible
      Esconder $200 en cada venta
    📅 Diezmo del día bueno
      Guardar la mitad del excedente
```
